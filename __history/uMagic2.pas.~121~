        ...
        if NormsLoaded then // Если нормы есть                                        //
          ...
          begin                                                                       //
            ...
            Exit;                                                                     //
                                                                                      ...
                                                                                      //
//        if MapLoaded then // Если карта обхода есть                                   //
//          if Lot.BlankWafer.NTotal <> Lot.Wafer[nWf].NTotal then                      //
//          begin                                                                       //
//            Print_Result('Карта обхода не подходит к пластине!', clRed);              //
//            Exit;                                                                     //
//          end;                                                                        //
                                                                                      //
        if CreateSTS = 1 then                                                         //
...
begin                                                                                 //
  ...
  Print_Result('>>> Файлы загружены!', clGreen);                                      //
                                                                                      //
  if Lot.BlankWafer.NTotal = 0 then
    if QuestMess(Handle, 'Карта обхода не была загружена!'+#13#10+'Хотите загрузить карту обхода?') = IDYES then
